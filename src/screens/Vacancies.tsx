              ...
              <div className="flex items-center gap-4 mb-6 px-1">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[11px] text-blue-600 font-bold uppercase tracking-widest">
                    {questions.filter((q) => !q.id.startsWith('b_')).length} personalizadas para {interviewCandidate.name}
                  </p>
                </div>
                <span className="text-outline">=</span>
                <p className="text-[11px] font-black text-on-surface uppercase tracking-widest">{questions.length} preguntas sin duplicados</p>
              </div>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {isBase ? (
                              ...
                              <span className="px-1.5 py-0.5 bg-blue-100 text-blue-600 text-[9px] font-black uppercase rounded">Personalizada</span>
                            )}
                          </div>
